...
{
  public static class EdgeInteropMethodNames
  {
    public const string EdgeInterop_InitializeEdge = "EdgeInterop.InitializeEdge";
    public const string EdgeAccountInterop_Logout = "EdgeInterop.EdgeUiContextInterop.EdgeAccountInterop.Logout";
    //public const string EdgeAccountInterop_GetFirstWalletInfo = "EdgeInterop.EdgeUiContextInterop.EdgeAccountInterop.GetFirstWalletInfo";
    public const string EdgeUiContextInterop_ShowLoginWindow = "EdgeInterop.EdgeUiContextInterop.ShowLoginWindow";
